...
// import com.sake.customers.search.CustomerSearchInput;
// import com.sake.customers.search.CustomerSearchInputRepository;
...
public class DeleteCustomerController {
    ...
    public @ResponseBody List<DeleteCustomer> getDeleteCustomer() {
        ...
        try {
        	...
        	ResultSet rs = stmt.executeQuery("select * from sake.delete_customer"
        			);
        	while (rs.next()) {
